...
function checkProgress(data){
    return  (data==1)? 'Pengajuan Baru'
            ...
            :(data.trim()=='3_1')? 'Menunggu Konfirmasi Reviewer'
            ...
            :(data.trim()=='7_1')? 'Menunggu Konfirmasi Reviewer'
            ...
            :(data.trim()=='8_1')? 'Menunggu Verifikasi Admin'
            :(data.trim()=='8_2')? 'Perbaikan Berkas'
            :(data.trim()=='8_3')? 'Audit Tahap 1 Selesai'
            //Pembayaran Tahap 2
            :(data==9)? 'Pembayaran Tahap 2'
            :(data.trim()=='9_0')? 'Belum Bayar'
            :(data.trim()=='9_1')? 'Menunggu Konfirmasi Sales'
            :(data.trim()=='9_2')? 'Pembayaran Gagal'
            :(data.trim()=='9_3')? 'Pembayaran Terkonfirmasi'
            ...
            :(data.trim()=='11_1')? 'Menunggu Pelanggan Upload Ulang Berita Acara'
            :(data.trim()=='11_2')? 'Berita Acara Terkonfirmasi'
            //Pelunasan
            :(data==12)? 'Pelunasan'
            :(data.trim()=='12_0')? 'Belum Bayar'
            :(data.trim()=='12_1')? 'Menunggu Konfirmasi Sales'
...
function notifProgress(data){
    ...
    return  (data==1)? 'Pengajuan Baru Berhasil Silahkan Lanjutkan Upload Berkas Pada Menu Unggah Data'
            ...
            //Berita Acara
            :(data==11)? 'Berita Acara'
            :(data.trim()=='12_0')? 'Belum Upload Berita Acara'
            :(data.trim()=='12_1')? 'Silahkan Upload Ulang Berita Acara Yang Sudah Ditandatangani'
            :(data.trim()=='12_2')? 'Berita Acara Terkonfirmasi Silahkan Lanjutkan Tahapan Berikutnya : Pelunasan dan Penerbitan Invoice'
            //Pelunasan
            :(data==12)? 'Silahkan Melakukan Pelunasan Sesuai Dengan Akad'
            :(data.trim()=='9_0')? 'Silahkan Upload Bukti Pelunasan'
            :(data.trim()=='9_1')? 'Silahkan Menunggu Konfirmasi Sales'
            :(data.trim()=='9_2')? 'Pelunasan Gagal Silahkan Upload Ulang Bukti Pelunasan'
            :(data.trim()=='9_3')? 'Pelunasan Sesuai dan Akan Dilanjutkan Pada Proses Selanjutnya Yaitu Penerbitan Invoice'
            //Proses Sidang Fatwa
            :(data==13)? 'Proses Sidang Fatwa'
            :'-'; 
