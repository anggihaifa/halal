						...
						<div class="form-group row" >
							...
							@if($tahap == 1)
								...
								<div class="col-lg-8">
									...
									<input type="text" class="form-control" name="lebih_tahap1" id="nominal_lebih1" required/>
								</div>
							...
							@elseif($tahap == 2)
								...
								<div class="col-lg-8">
									...
									<input type="text" class="form-control" name="lebih_tahap2" id="nominal_lebih2" required/>
								</div>
							...
							@elseif($tahap == 3)
								...
								<div class="col-lg-8">
									...
									<input type="text" class="form-control" name="lebih_tahap3" id="nominal_lebih3" required />
								</div>
...
<script type="text/javascript">		
		if(document.getElementById("nominal_lebih1")){
			var rupiah1 = document.getElementById("nominal_lebih1");
			rupiah1.addEventListener('keyup', function(e){									
				rupiah1.value = formatRupiah(this.value, 'Rp. ');			
			});
		}else if(document.getElementById("nominal_lebih2")){
			var rupiah2 = document.getElementById("nominal_lebih2");
			rupiah2.addEventListener('keyup', function(e){									
				rupiah2.value = formatRupiah(this.value, 'Rp. ');			
			});
		}else if(document.getElementById("nominal_lebih3")){
			var rupiah3 = document.getElementById("nominal_lebih3");
