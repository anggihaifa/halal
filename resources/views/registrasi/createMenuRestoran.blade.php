...
@section('title', 'Tambah Menu Restoran')
...
@section('content')
	...
	<ol class="breadcrumb float-xl-right">
		...
		<li class="breadcrumb-item active">Tambah Menu Restoran</li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Tambah Menu Restoran <small>{{$dataRegistrasi[0]['perusahaan']}}</small></h1>
	<!-- end page-header -->
	<!-- begin row -->
	<div class="row">
		<!-- begin col-12 -->
		<div class="col-xl-12">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-7">
				...
				<div class="panel-body panel-form">
                    <form action="{{route('storemenurestoran')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
						<div class="form-group row">
                            @csrf

							@component('components.inputtext',['name'=> 'menu','label' => 'Nama Menu','required'=>true,'placeholder'=>'Nama Menu'])@endcomponent
