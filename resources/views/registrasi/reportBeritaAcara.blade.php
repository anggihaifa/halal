...
@section('content')
	...
	<ol class="breadcrumb float-xl-right">
		...
		<li class="breadcrumb-item active">Report Berita Acara</li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Report Berita Acara<small></small></h1>
	<!-- end page-header -->
	<!-- begin row -->
	<div class="row">
		<!-- begin col-12 -->
		<div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-7">
				...
				<div class="panel-heading">
					<h4 class="panel-title">Report Berita Acara</h4>
				...
				<div class="panel-body panel-form">
					<form action="{{route('registrasi.accberitaacaraadmin',["id" => $data->id])}}" method="post"  class="form-horizontal form-bordered" enctype="multipart/form-data">
						@csrf
						@method('PUT')
