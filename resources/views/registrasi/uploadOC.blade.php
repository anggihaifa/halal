		...
		<div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-7">
				...
				<div class="panel-body panel-form">
					<form action="{{route('registrasi.uploadfileocadmin',['id' => $data->id])}}" method="post"  class="form-horizontal form-bordered" enctype="multipart/form-data">
						@csrf
						@method('PUT')
						<div class="form-group row" >
							...
							@if($data->status_oc == 1 || $data->status_oc == 2)
								...
								<label class="col-lg-4 col-form-label">Upload OC</label>
								<div class="col-lg-8">
