						...
						<div class="form-group row" >
							...
							@if($tahap == 1)
								...
								<div class="col-lg-8">
									...
									<input type="text" class="form-control" name='kurang_tahap1'/>
								</div>
							...
							@elseif($tahap == 2)
								...
								<div class="col-lg-8">
									...
									<input type="text" class="form-control" name='kurang_tahap2'/>
								</div>
							...
							@elseif($tahap == 3)
								...
								<div class="col-lg-8">
									...
									<input type="text" class="form-control" name='kurang_tahap3'/>
								</div>
