                ...
                <div class="panel-body panel-form">
                    <form action="{{route('registrasiHalal.store')}}" method="post" name="registerForm" class="form-horizontal form-bordered" enctype="multipart/form-data" id="msform">
                        ...
                        <ul id="progressbar">
                            ...
                            <li id="pj" class="text-center"><strong>Penanggung Jawab</strong></li>
                            <li id="dph" class="text-center"><strong>Data Penyelia Halal</strong></li>
                            <li id="dp" class="text-center"><strong>Data Produk</strong></li>
                            <li id="dsm" class="text-center"><strong>Data Sistem Manajemen</strong></li>
                            <li id="dll" class="text-center"><strong>Data Lokasi Lainnya</strong></li>
                        </ul> <!-- fieldsets -->
    ...
    <script>
        ...
        function autofill(){
            if(document.getElementById("autofill_alamat").checked){                                              
                ...
                document.getElementById("kodepos_pabrik").value = document.getElementById("kodepos_kantor").value;
                document.getElementById("email_pabrik").value = document.getElementById("email_kantor").value;                                                
                $('#prov_pabrik').selectpicker('refresh');
                $('#negara_pabrik').selectpicker('refresh');
                $.ajaxSetup({
                    headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }
                });
        ...
        function getSelectedValue(){
            ...
            if(selectedValue == 1 || selectedValue == 5){
                ...
                if(selectedValue == 1){
                    document.getElementById("wrapperip").style.display = 'block';
                    document.getElementById("wrappersni").style.display = 'none';
                }else if(selectedValue == 5){
                    document.getElementById("wrapperip").style.display = 'none';
                    document.getElementById("wrappersni").style.display = 'block';
                }
        ...
        // var ktp = document.getElementById('no_tipe');
