...
@section('content')
	...
	<ol class="breadcrumb float-xl-right">
		...
		<li class="breadcrumb-item active"><a href="#">PT BKI (Persero)</a></li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Non Tanah dan Bangunan / PT BKI (Persero) <small></small></h1>
	<!-- end page-header -->
	<!-- begin panel -->
	<div class="panel panel-inverse">
		<!-- begin panel-heading -->
		<div class="panel-heading">
			<h4 class="panel-title">Non Tanah dan Bangunan / PT BKI (Persero) </h4>
