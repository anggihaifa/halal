				...
				<div class="tab-content p-0 m-0">
					...
					<div class="tab-pane fade active show" id="card-tab-1">
							@php
								...
								$buttonUnduhDisabled = '<td class="valign-middle text-center"><a href="#" ><i class="fa fa-eye" target="blank" style="color:grey;"></i></a></td>';
									...
									@else
											@foreach($dataHas as $has => $value)
												...
												<tr class="odd">
													...
													<td class="valign-middle">Manual Sistem Jaminan Produk Halal (SJPH)</td>
													@if($value['has_1'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_1')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_1" name="status_has_1" class="form-control selectpicker" data-size="10" data-live-search="true"@if($value["status_has_1"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_1"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_1"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_1"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_1"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_1"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													@if($value['has_2'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_2')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_2" name="status_has_2" class="form-control selectpicker" data-size="10" data-live-search="true"
															@if($value["status_has_2"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_2"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_2"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_2"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_2"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_2"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="odd">
													...
													@if($value['has_3'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_3')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_3" name="status_has_3" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_3"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_3"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_3"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_3"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_3"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_3"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													<td class="valign-middle">Data Produk Konsinyasi/Titipan (Khusus Restoran/Catering)</td>
													@if($value['has_4'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_4')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_4" name="status_has_4" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_4"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_4"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_4"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_4"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_4"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_4"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="odd">
													...
													<td class="valign-middle">Data Bahan Baku, Bahan Tambahan dan Bahan Penolong</td>
													@if($value['has_5'] !== null)
													<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_5')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_5" name="status_has_5" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_5"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_5"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_5"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_5"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_5"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_5"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													@if($value['has_6'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_6')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_6" name="status_has_6" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_6"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_6"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_6"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_6"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_6"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_6"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="odd">
													...
													<td class="valign-middle">Copy Sertifikat Halal Pada Produk Konsinyasi/Titipan (Khusus Restoran/Catering)</td>
													@if($value['has_7'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_7')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_7" name="status_has_7" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_7"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_7"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_7"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_7"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_7"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_7"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													<td class="valign-middle">Informasi Formula/Resep Produk Tanpa Gramasi Yang Disahkan Oleh Personil Yang Berwenang</td>
													@if($value['has_8'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_8')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_8" name="status_has_8" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_8"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_8"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_8"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_8"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_8"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_8"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="odd">
													...
													<td class="valign-middle">Diagram Alir Proses Untuk Produk Yang disertifikasi</td>
													@if($value['has_9'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_9')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_9" name="status_has_9" class="form-control selectpicker" data-size="10" data-live-search="true"  @if($value["status_has_9"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_9"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_9"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_9"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_9"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_9"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													@if($value['has_10'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_10')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_10" name="status_has_10" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_10"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_10"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_10"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_10"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_10"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_10"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													@if($value['has_11'] !== null)
														...
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_11')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_11" name="status_has_11" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_11"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_11"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_11"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_11"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_11"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_11"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													@if($value['has_12'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_12')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_12" name="status_has_12" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_12"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_12"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_12"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_12"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_12"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_12"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													@if($value['has_13'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_13')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_13" name="status_has_13" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_13"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_13"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_13"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_13"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_13"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_13"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													@if($value['has_14'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_14')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_14" name="status_has_14" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_14"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_14"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_14"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_14"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_14"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_14"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													@if($value['has_15'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_15')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_15" name="status_has_15" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_15"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_15"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_15"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_15"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_15"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_15"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="odd">
													...
													@if($value['has_16'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_16')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
														{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_16" name="status_has_16" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_16"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_16"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_16"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_16"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_16"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_16"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="even">
													...
													@if($value['has_17'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_17')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
													{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_17" name="status_has_17" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_17"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_17"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_17"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_17"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_17"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_17"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
												...
												<tr class="odd">
													...
													@if($value['has_18'] !== null)
														<td class="text-nowrap valign-middle text-center"><a href="{{url('penjadwalan_viewer/'.$value['id_registrasi'].'/has_18')}}" target="_blank"><i class="fa fa-eye"></i></a></td>
													@else
													{!! $buttonUnduhDisabled !!}
													@endif
													@if(auth()->user()->usergroup_id == 3 || auth()->user()->usergroup_id == 1)
														<td>
															<select id="status_has_18" name="status_has_18" class="form-control selectpicker" data-size="10" data-live-search="true" @if($value["status_has_18"] == 1) data-style="btn-green btn-sm";@elseif($value["status_has_18"] == 3) data-style="btn-grey btn-sm";@elseif($value["status_has_18"] == 2) data-style="btn-red btn-sm";@else data-style="btn-white btn-sm" @endif>
																<option value="" {{$value["status_has_18"] == null ? 'selected' : ''}}>Belum Diperiksa</option>
																<option value="1" {{$value["status_has_18"] == 1 ? 'selected' : ''}}>Sesuai</option>
																<option value="2" {{$value["status_has_18"] == 2 ? 'selected' : ''}}>Tidak Sesuai</option>
