							...
							@endforeach
								...
								<div style="margin-bottom:10px;">
                                    ...
                                    <div class="radio radio-css ">
                                        ...
                                        <label for="tidak_memenuhi"><b>Audit Tahap II dapat dilaksanakan setelah semua tindak lanjut temuan sudah dinyatakan memenuhi, dengan batas maksimal penyerahan dokumen perbaikan tanggal</b></label>
                                    </div>
								</div>
