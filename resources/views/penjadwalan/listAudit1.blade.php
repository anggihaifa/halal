...
@section('content')
    ...
    <ol class="breadcrumb float-xl-right">
        <li class="breadcrumb-item"><a href="#">Audit Tahap 1</a></li>
        <li class="breadcrumb-item active"><a href="#">List Audit Tahap 1</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">List Audit Tahap 1  <small></small></h1>
    <!-- end page-header -->
    <!-- begin panel -->
    <div class="panel panel-inverse">
        <!-- begin panel-heading -->
        <div class="panel-heading">
            <h4 class="panel-title">List Audit Tahap 1</h4>
                    ...
                    },
                    {
                        ...
                        "render":function (data,type,full,meta) {
                            if(full.pelaksana2_audit1){
                                var str = full.pelaksana2_audit1.split("_");
                                return str[1]
                            }else{
                                return ''
                            }
