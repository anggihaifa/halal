...
@section('content')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Pelatihan<small></small></h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
        <!-- begin col-12 -->
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-7">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Edit Pelatihan</h4>
                ...
                <div class="panel-body panel-form">
                    <form action="{{route('editpelatihan.store')}}" method="post"  class="form-horizontal form-bordered" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">                            
                            ...
                            @component('components.inputtext',['name'=> 'judul_pelatihan','label' => 'Judul Pelatihan','required'=>true,'placeholder'=>'Judul Berita','value'=>$pelatihan->judul_pelatihan,'readonly'=>false])@endcomponent
                            ...
                            <div id="dgambarpelatihan" class="col-lg-8">
                                <input type="file" class="form-control" name="gambar_cover" value="{{$pelatihan->gambar_cover}}">
                            </div>

                            <label id="jisiberita" class="col-lg-12 col-form-label">Isi Pelatihan</label>
                            <div id="disiberita" class="col-lg-12">
                                <textarea class="form-control" name="isi_pelatihan" id="summernote">@php echo $pelatihan->isi_pelatihan @endphp</textarea>
                            </div>
