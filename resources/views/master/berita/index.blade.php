...
@section('content')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">List Berita  <small></small></h1>
    <!-- end page-header -->
    <!-- begin panel -->
    <div class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-heading-btn">                                
                <a href="{{route('berita.create')}}" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Tambah Berita</a>
        ...
        $('#table').DataTable({
            columns:[
                ...
                },
                {
                    ...
                    "render":function (data,type,full,meta) {                            
                        // return `<a href="{{url('upload_kontrak_akad_admin')}}/`+full.id+`" class="btn btn-indigo btn-xs">&nbsp;&nbsp;Detail&nbsp;&nbsp;</a>`
                        return `<a href="{{url('detail_berita')}}/`+full.id+`" class="btn btn-indigo btn-xs">&nbsp;&nbsp;Detail&nbsp;&nbsp;</a>`
                    }
                },
                {
                    "data":null,
                            ...
                            if(full.status_approve == 0){
                                return `<div class="btn-group m-r-5 show">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdownIcon" x-placement="top-end">
                                        ...
                                        <a href="{{url('acc_berita')}}/`+full.id+`" class="dropdown-item" ><i class="fa fa-check-circle"></i> Acc</a>

                                        <a href="{{url('master/berita')}}/`+full.id+`/edit" class="dropdown-item" ><i class="fa fa-edit"></i> Edit</a>

                                        <form class="forDelete dropdown-item" action="{{url('master/berita')}}/${full.id}" method="post" style="padding:0px;">
                                            @csrf
                                            @method('DELETE')
                                ...
                                return `<div class="btn-group m-r-5 show">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdownIcon" x-placement="top-end">
                                        ...
                                        <a href="{{url('acc_berita')}}/`+full.id+`" class="dropdown-item" ><i class="fa fa-check-circle"></i> Cabut Acc</a>
