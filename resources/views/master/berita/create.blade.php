...
@section('content')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Tambah Berita<small></small></h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
        <!-- begin col-12 -->
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-7">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Tambah Berita</h4>
                ...
                <div class="panel-body panel-form">
                    <form action="{{route('berita.store')}}" method="post" name="registerForm" class="form-horizontal form-bordered" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">                            
                            ...
                            @component('components.inputtext',['name'=> 'judul_berita','label' => 'Judul Berita','required'=>true,'placeholder'=>'Judul Berita','readonly'=>false])@endcomponent

                            {{-- <label id="tglpublikasi" class="col-lg-4 col-form-label">Tanggal Publikasi</label>
                            <div id="dtglpublikasi" class="col-lg-8">
                                <div class="input-group date">
                                    <input id="tgl_publikasi" name="tanggal_publikasi" type="text" class="form-control" placeholder="Tanggal Publikasi"  data-date-start-date="Date.default" />
