...
@section('title', 'Master Kelompok Produk')

@section('content')
    <!-- begin breadcrumb -->
    <ol class="breadcrumb float-xl-right">
        <li class="breadcrumb-item"><a href="#">Master</a></li>
        <li class="breadcrumb-item active"><a href="#">Kelompok Produk</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Master Kelompok Produk  <small></small></h1>
    <!-- end page-header -->
    <!-- begin panel -->
    <div class="panel panel-inverse">
        <!-- begin panel-heading -->
        <div class="panel-heading">
            <h4 class="panel-title">Master Kelompok Produk </h4>
            <div class="panel-heading-btn">
                <a href="{{route('kelompok_produk.create')}}" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
...
@push('scripts')
    <script>
        $('#table').DataTable({
                    ...
                    "render":function (data,type,full,meta) {
                        return `<div class="btn-group m-r-5 show">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdownIcon" x-placement="top-end">
                                    ...
                                    <a href="{{url('master/kelompok_produk')}}/`+full.id+`/edit" class="dropdown-item" ><i class="fa fa-edit"></i> Edit</a>

                                    <form class="forDelete dropdown-item" action="{{url('master/kelompok_produk')}}/${full.id}" method="post" style="padding:0px;">
                                        @csrf
                                        @method('DELETE')
            ...
            processing:true,
            serverSide:true,
            ajax:"{{route('master.kelompokproduk.datatable')}}",
            order:[[0,'asc']]
        });
