...
@php
	...
	//$pageContainerClass .= (!empty($sidebarLight)) ? ' ' : '';
	//$pageContainerClass .= (!empty($sidebarWide)) ? 'page-with-wide-sidebar ' : '';
	$pageContainerClass .= 'page-with-wide-sidebar ';
...
<body class="{{ $bodyClass }}">
	...
	<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed {{ $pageContainerClass }} custom-bg-gum">
