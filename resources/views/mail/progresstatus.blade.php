...
<body class="body">
    ...
    @elseif($registrasi['status']== '8')
            ...
            <div style="border:solid; ">
                <table style="width:100%; margin-top:10px;  border: 1px solid black;">
                        ...
                        $dl_tahap1 = date("Y-m-d h:i:sa", time() + 86400);
    ...
    @elseif($registrasi['status']== '35')
            ...
            <div style="border:solid; ">
                <table style="width:100%; margin-top:10px;  border: 1px solid black;">
                        ...
                        $dl_tahap2 = date("Y-m-d h:i:sa", time() + 86400);
    ...
    @elseif($registrasi['status']== '40')
            ...
            <p>
             ...
             <p>Anda dapat meninjau order dan mengunduh bukti pembayaran tahap 2 anda di menu pembayaran pada menu navigasi registrasi halal tekan tombol aksi lalu pilih menu pembayaran pada kolom bukti pembayaran tahap 1. Untuk informasi lebih lanjut, silahkan menghubungi Customer Care kami.
             </p>          
