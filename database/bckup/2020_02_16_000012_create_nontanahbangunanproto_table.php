...
class CreateNontanahbangunanprotoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nontanahbangunanproto', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('nontanahbangunanproto');
    }
}
